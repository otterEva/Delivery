...
class PrepareApiRequestService:
        ...
        for first_object in data:
            for second_object in data:
                if second_object == first_object:
                    continue
                if (
                    data[first_object]["object_type"] == 1
                    and data[second_object]["object_type"] == 1
                ):
                    continue
                if (
                    data[first_object]["object_type"] == 1
                    and data[second_object]["object_type"] == 2
                ):
                    continue
                if (
                    data[first_object]["object_type"] == 2
                    and data[second_object]["object_type"] == 1
                ):
                    continue
                if (
                    data[first_object]["object_type"] == 3
                    and data[second_object]["object_type"] == 1
                ):
                    continue
                if (
                    data[first_object]["object_type"] == 2
                    and data[second_object]["object_type"] == 3
                    and (data[second_object]["relative"] == first_object)
                ):
                    continue
    ...
    def _prepare_request(self, from_list, to_list):
        ...
        points.append(
            {"lat": from_list[0][1].address[0], "lon": from_list[0][1].address[1]}
        )
        sources.append(0)
